...
var isBuffer_1 = createCommonjsModule((function(module, exports) {
  var freeExports = exports && !exports.nodeType && exports, freeModule = freeExports && module && !module.nodeType && module, Buffer = freeModule && freeModule.exports === freeExports ? _root.Buffer : void 0, isBuffer = (Buffer ? Buffer.isBuffer : void 0) || stubFalse_1;
...
function SplitDecoration(props) {
  ...
  if (1 === import_react.Children.count(children)) return (0, import_jsx_runtime.jsx)("tbody", { className: computedClassName, children: (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { colSpan: columnCount, className: computedContentClassName, children }) }) });
  var _children = _slicedToArray(children, 2), gutter = _children[0], content = _children[1];
  return (0, import_jsx_runtime.jsx)("tbody", { className: computedClassName, children: (0, import_jsx_runtime.jsxs)("tr", { children: [!hideGutter && (0, import_jsx_runtime.jsx)("td", { className: computedGutterClassName, children: gutter }), (0, import_jsx_runtime.jsx)("td", { colSpan: headerContentColSpan, className: computedContentClassName, children: content })] }) });
}
function UnifiedDecoration(props) {
  var hideGutter = props.hideGutter, className = props.className, gutterClassName = props.gutterClassName, contentClassName = props.contentClassName, children = props.children, computedClassName = classnames("diff-decoration", className), computedGutterClassName = classnames("diff-decoration-gutter", gutterClassName), computedContentClassName = classnames("diff-decoration-content", contentClassName);
  if (1 === import_react.Children.count(children)) return (0, import_jsx_runtime.jsx)("tbody", { className: computedClassName, children: (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { colSpan: hideGutter ? 1 : 3, className: computedContentClassName, children }) }) });
  var _children = _slicedToArray(children, 2), gutter = _children[0], content = _children[1];
  return (0, import_jsx_runtime.jsx)("tbody", { className: computedClassName, children: (0, import_jsx_runtime.jsxs)("tr", { children: [!hideGutter && (0, import_jsx_runtime.jsx)("td", { colSpan: 2, className: computedGutterClassName, children: gutter }), (0, import_jsx_runtime.jsx)("td", { className: computedContentClassName, children: content })] }) });
}
function Decoration(props) {
  var _props$className = props.className, className = void 0 === _props$className ? "" : _props$className, _props$gutterClassNam = props.gutterClassName, gutterClassName = void 0 === _props$gutterClassNam ? "" : _props$gutterClassNam, _props$contentClassNa = props.contentClassName, contentClassName = void 0 === _props$contentClassNa ? "" : _props$contentClassNa, children = props.children, _useDiffSettings = useDiffSettings(), viewType = _useDiffSettings.viewType, gutterType = _useDiffSettings.gutterType, monotonous = _useDiffSettings.monotonous, RenderingDecoration = "split" === viewType ? SplitDecoration : UnifiedDecoration, childrenCount = import_react.Children.count(children), hideGutter = "none" === gutterType;
  return warning_1(childrenCount <= 2, "Decoration only accepts a maxium of 2 children"), warning_1(childrenCount < 2 || !hideGutter, "Gutter element in decoration will not be rendered since hideGutter prop is set to true"), (0, import_jsx_runtime.jsx)(RenderingDecoration, { hideGutter, monotonous, className, gutterClassName, contentClassName, children });
}
...
function markWord(word, name) {
  var mark = /* @__PURE__ */ (function(word2, name2, replacement) {
    return function(paths) {
      return flatMap_1(paths, (function(path) {
        var leaf = leafOf(path);
        return leaf.value.includes(word2) ? leaf.value.split(word2).reduce((function(output, text, i) {
          return 0 !== i && output.push(replace(path, { type: "mark", markType: name2, value: replacement })), text && output.push(replace(path, _objectSpread2(_objectSpread2({}, leaf), {}, { value: text }))), output;
        }), []) : [path];
      }));
    };
  })(word, name, arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : word);
  return function(_ref) {
    var _ref2 = _slicedToArray(_ref, 2), oldLinesOfPaths = _ref2[0], newLinesOfPaths = _ref2[1];
...
function useCollection() {
  var _useReducer2 = _slicedToArray((0, import_react.useReducer)(updateCollection, []), 2), collection = _useReducer2[0], dispatch = _useReducer2[1];
  return { collection, clear: function() {
    dispatch({ type: "clear" });
  }, push: function(value) {
...
function useChangeSelect(hunks) {
  var _ref$multiple = (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}).multiple, multiple = void 0 !== _ref$multiple && _ref$multiple, _useCollection = useCollection(), collection = _useCollection.collection, clear = _useCollection.clear, toggle = _useCollection.toggle, only = _useCollection.only;
  return (0, import_react.useEffect)(clear, [hunks]), [collection, function(_ref2) {
...
function useSourceExpansion(hunks, oldSource) {
  var _useCollection = useCollection(), expandedRanges = _useCollection.collection, clear = _useCollection.clear, push = _useCollection.push;
  (0, import_react.useEffect)(clear, [hunks, oldSource]);
  var linesOfOldSource = (0, import_react.useMemo)((function() {
    return Array.isArray(oldSource) ? oldSource : (oldSource || "").split("\n");
  }), [oldSource]);
  return [(0, import_react.useMemo)((function() {
    return linesOfOldSource.length ? expandedRanges.reduce((function(hunks2, _ref) {
      var _ref2 = _slicedToArray(_ref, 2), start = _ref2[0], end = _ref2[1];
      return expandFromRawCode(hunks2, linesOfOldSource, start, end);
    }), hunks) : hunks;
...
function shallowEqualObjects(objA, objB) {
  ...
  const aKeys = Object.keys(objA), bKeys = Object.keys(objB), len = aKeys.length;
...
var current;
var _excluded$1 = ["hunks"];
var _excluded2 = ["hunks"];
...
function defaultShouldTokenize(current2, prev) {
  if (!prev) return true;
  var yHunks, currentHunks = current2.hunks, currentPayload = _objectWithoutProperties(current2, _excluded$1), prevHunks = prev.hunks, prevPayload = _objectWithoutProperties(prev, _excluded2);
...
function useTokenizeWorker(worker, payload) {
  var value, equals, cache, identifier, _options$shouldTokeni = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).shouldTokenize, shouldTokenize = void 0 === _options$shouldTokeni ? defaultShouldTokenize : _options$shouldTokeni, payloadIdentifier = (value = payload, equals = function(current2, previous) {
    return !shouldTokenize(current2, previous);
  }, cache = (0, import_react.useRef)(void 0), identifier = (0, import_react.useRef)(0), equals(value, cache.current) || (cache.current = value, identifier.current = identifier.current + 1), identifier.current), _useState2 = _slicedToArray((0, import_react.useState)({ tokens: null, tokenizationFailReason: null }), 2), tokenizeResult = _useState2[0], setTokenizeResult = _useState2[1], job = (0, import_react.useRef)(null);
  return (0, import_react.useEffect)((function() {
    var receiveTokens = function(_ref) {
      var _ref$data = _ref.data, payload2 = _ref$data.payload;
      _ref$data.id === job.current && (payload2.success ? setTokenizeResult({ tokens: payload2.tokens, tokenizationFailReason: null }) : setTokenizeResult({ tokens: null, tokenizationFailReason: payload2.reason }));
    };
    return worker.addEventListener("message", receiveTokens), function() {
      return worker.removeEventListener("message", receiveTokens);
    };
  }), [worker]), (0, import_react.useEffect)((function() {
    job.current = uid();
    var data = { payload, id: job.current, type: "tokenize" };
...
function withSourceExpansion() {
  return function(ComponentIn) {
    function ComponentOut(props) {
      var _useSourceExpansion2 = _slicedToArray(useSourceExpansion(props.hunks, props.oldSource), 2), renderingHunks = _useSourceExpansion2[0], expandRange = _useSourceExpansion2[1];
      return (0, import_jsx_runtime.jsx)(ComponentIn, _objectSpread2(_objectSpread2({}, props), {}, { hunks: renderingHunks, onExpandRange: expandRange }));
    }
...
function minCollapsedLines(minLinesExclusive) {
  return function(ComponentIn) {
    function ComponentOut(props) {
      ...
      return (0, import_jsx_runtime.jsx)(ComponentIn, _objectSpread2(_objectSpread2({}, props), {}, { hunks: renderingHunks }));
    }
...
function withChangeSelect(options) {
  return function(ComponentIn) {
    function ComponentOut(props) {
      var _useChangeSelect2 = _slicedToArray(useChangeSelect(props.hunks, options), 2), selectedChanges = _useChangeSelect2[0], toggleChangeSelection = _useChangeSelect2[1];
      return (0, import_jsx_runtime.jsx)(ComponentIn, _objectSpread2(_objectSpread2({}, props), {}, { selectedChanges, onToggleChangeSelection: toggleChangeSelection }));
    }
...
function withTokenizeWorkerwithTokenizeWorker(worker) {
  var options = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _options$mapPayload = options.mapPayload, mapPayload = void 0 === _options$mapPayload ? defaultMapPayload : _options$mapPayload, hookOptions = _objectWithoutProperties(options, _excluded);
  return function(ComponentIn) {
    function ComponentOut(props) {
      var payload = (function(props2) {
        var hunks = props2.hunks, oldSource = props2.oldSource, language = props2.language;
        return mapPayload({ language, oldSource, hunks }, props2);
      })(props), tokenizationResult = useTokenizeWorker(worker, payload, hookOptions);
      return (0, import_jsx_runtime.jsx)(ComponentIn, _objectSpread2(_objectSpread2({}, props), tokenizationResult));
    }
...
export {
  ...
  withChangeSelect,
  withSourceExpansion,
  withTokenizeWorkerwithTokenizeWorker as withTokenizeWorker
};
//# sourceMappingURL=react-diff-view.js.map
